  ...
  const [bannerTypes, setBannerTypes] = useState([
    {
      ...
      icon: <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.2" clipPath="url(#clip0_1361_507)">
          <path d="M10.6671 8H32.0004L29.3337 32H13.3337L10.6671 8Z" stroke="#2E1708" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M18.6671 48H24.0004V56H18.6671V48Z" stroke="#2E1708" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M53.3334 8V40H40.0001C39.9388 30.184 40.4908 20.2507 53.3334 8Z" stroke="#2E1708" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M53.3337 40V56H50.6671V48" stroke="#2E1708" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M21.3329 32V48" stroke="#2E1708" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
    ...
    },
    {
      ...
      icon: <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.2" clipPath="url(#clip0_1361_498)">
          <path d="M32.0002 8C38.2291 13.5109 46.3588 16.3802 54.6669 16C55.8765 20.1147 56.2466 24.4306 55.7552 28.6912C55.2639 32.9517 53.9211 37.0701 51.8067 40.8014C49.6922 44.5328 46.8493 47.801 43.4468 50.4119C40.0443 53.0229 36.1517 54.9232 32.0002 56C27.8488 54.9232 23.9562 53.0229 20.5537 50.4119C17.1512 47.801 14.3083 44.5328 12.1938 40.8014C10.0794 37.0701 8.73661 32.9517 8.24525 28.6912C7.7539 24.4306 8.124 20.1147 9.33358 16C17.6417 16.3802 25.7714 13.5109 32.0002 8Z" stroke="#6F4025" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
      ...
      bannerDescription: "Firearms are now the leading cause of death among children. A distressing frequency that alarms students, parents and teachers. Help schools add a range of new high-tech security measures without diverting funds from other education needs. "
    },
    {
      name: "Mental Health Relief",
      description: "Youth Mental Health is in Crisis. More text goes here. ",
      icon: <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g opacity="0.2" clipPath="url(#clip0_1361_488)">
          <path d="M31.9994 21.3333C35.6813 21.3333 38.6661 18.3486 38.6661 14.6667C38.6661 10.9848 35.6813 8 31.9994 8C28.3175 8 25.3328 10.9848 25.3328 14.6667C25.3328 18.3486 28.3175 21.3333 31.9994 21.3333Z" stroke="#6F4025" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M32.0005 56.9812L45.5871 43.3919C46.3599 42.6291 46.9742 41.7209 47.3946 40.7197C47.815 39.7185 48.0333 38.6441 48.0368 37.5582C48.0403 36.4723 47.829 35.3965 47.4151 34.3926C47.0012 33.3887 46.3928 32.4766 45.6249 31.7088C44.8571 30.9409 43.945 30.3325 42.9411 29.9186C41.9372 29.5047 40.8614 29.2934 39.7755 29.2969C38.6896 29.3004 37.6152 29.5187 36.614 29.9391C35.6128 30.3595 34.7046 30.9738 33.9418 31.7466L32.0005 33.6852L30.0591 31.7466C29.2963 30.9738 28.3881 30.3595 27.3869 29.9391C26.3858 29.5187 25.3113 29.3004 24.2254 29.2969C23.1396 29.2934 22.0637 29.5047 21.0598 29.9186C20.0559 30.3325 19.1438 30.9409 18.376 31.7088C17.6082 32.4766 16.9998 33.3887 16.5858 34.3926C16.1719 35.3965 15.9606 36.4723 15.9642 37.5582C15.9677 38.6441 16.1859 39.7185 16.6063 40.7197C17.0267 41.7209 17.641 42.6291 18.4138 43.3919L32.0005 56.9812V56.9812Z" stroke="#6F4025" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
        </g>
        <defs>
      ...
      bannerDescription: "Student mental health has reached crisis levels. Districts across the country are desperate to hire more mental health specialists, roll out new coping tools and expanding curriculum that prioritizes emotional health."
    },
  ])
  ...
  return (
    <div className='min-h-220'>
      ...
      <div className='banner-image w-full h-174 relative'>
        ...
        <div className='w-64 lg:w-152 absolute top-0 left-4 lg:top-49 lg:left-26 z-10'>
