            ...
            <div className='sm:px-78 py-20'>
                ...
                <div className='mt-10'>
                    ...
                    <div className='relative mt-1'>
                        <input type="text" className='w-full h-14 border-1 mt-2 focus:outline-none pl-10 rounded-lg' placeholder='Donation Amount' value={donationAmount} onChange={e => setDonationAmount(e.target.value)} />
